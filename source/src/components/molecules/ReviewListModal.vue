                    ...
                    <transition-group name="fade">
                        ...
                        :key="text[text.symVueId]">
                            <div :class="$style['text-area']">
                                <div :class="$style['text-area-label-review-time']">
                                    <AutoHeightTextArea 
                                        :placeholder="'指摘日時'" 
                                        :value="text.reviewDate" 
                                        @input="inputValueList[i].reviewDate = $event" 
                                        :title="'指摘日時'"                                    
                                        :font-size="17"
                                ...
                                <div  :class="$style['text-area-label-review-content']">
                                    <AutoHeightTextArea 
                                        :placeholder="'指摘内容'" 
                                        :value="text.reviewContent" 
                                        @input="inputValueList[i].reviewContent = $event" 
                                        :title="'指摘内容'"       
                                        :font-size="17"
                                        :background-color="'rgb(45, 45, 45)'"
                                        :color="'rgb(241, 241, 241)'"
                                ...
                                <div :class="$style['text-area-label-treatment-time']">
                                    <AutoHeightTextArea 
                                        :placeholder="'処置日時'" 
                                        :value="text.treatmentTime" 
                                        @input="inputValueList[i].treatmentTime = $event" 
                                        :title="'処置日時'"                                    
                                        :font-size="17"
                                        :background-color="'rgb(45, 45, 45)'"
                                        :color="'rgb(241, 241, 241)'"
                                ...
                                <div  :class="$style['text-area-label-treatment-content']">
                                    <AutoHeightTextArea 
                                        :placeholder="'処置内容'"
                                        :value="text.treatment" 
                                        @input="inputValueList[i].treatment = $event" 
                                        :title="'処置内容'"      
                                        :font-size="17"
                                        :background-color="'rgb(45, 45, 45)'"
                                        :color="'rgb(241, 241, 241)'"
...
.text-area-label-review-content{
    min-height: 100px;
    background-color: rgb(45, 45, 45);
    border-top:solid 1px rgba(51, 54, 53, 1);
    border-left:solid 1px rgba(51, 54, 53, 1);
...
.text-area-label-treatment-time{
    min-height: 100px;
    background-color: rgb(45, 45, 45);
    border-top:solid 1px rgba(51, 54, 53, 1);
    border-left:solid 1px rgba(51, 54, 53, 1);
...
.text-area-label-treatment-content{
    min-height: 100px;
    background-color: rgb(45, 45, 45);
    border-top:solid 1px rgba(51, 54, 53, 1);
    border-left:solid 1px rgba(51, 54, 53, 1);
...
.text-area-label-review-time{
    grid-area:text-area-label-review-time ;
}
.text-area-label-review-content{
    grid-area:text-area-label-review-content;
}
.text-area-label-treatment-time{
    grid-area:text-area-label-treatment-time ;
}
.text-area-label-treatment-content{
    grid-area:text-area-label-treatment-content;
}
...
.text-area{
    display: grid;
    grid-template:
    "....  text-area-label-review-time text-area-label-review-content text-area-label-treatment-time text-area-label-treatment-content text-delete-button ....." auto
    /0.1fr 0.22fr                      1fr                           0.22fr                          1fr                               0.04fr              0.1fr;
}
